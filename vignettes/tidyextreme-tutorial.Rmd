...
Counts the number of days per year when daily maximum temperature exceeds 25 \textdegree{}C, following ETCCDI definition SU25.
...
threshold: Temperature threshold in  \textdegree{}C (default: 25)
```
...
Counts the number of days per year when daily minimum temperature exceeds 20 \textdegree{}C, following ETCCDI definition TR20.
...
threshold: Temperature threshold in  \textdegree{}C (default: 20)
```
...
Counts the number of days per year when daily temperature is greater than or equal to 30 \textdegree{}C.
...
Counts the number of days per year when daily temperature is greater than or equal to 35 \textdegree{}C.
...
Counts the number of days per year when daily temperature is less than 0 \textdegree{}C.
